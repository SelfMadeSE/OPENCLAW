...
CREATE TABLE IF NOT EXISTS subscriptions (
    ...
    plan_type TEXT NOT NULL CHECK (plan_type IN ('ai_receptionist_standard', 'ai_receptionist_business', 'ai_receptionist_enterprise')),
...
CREATE TABLE IF NOT EXISTS leads (
    ...
    phone TEXT,
    company TEXT,
    service_interest TEXT NOT NULL CHECK (service_interest IN ('ai_receptionist', 'web_design', 'app_development', 'automation', 'marketing', 'other')),
