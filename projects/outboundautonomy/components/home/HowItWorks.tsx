...
const steps = [
  {
    ...
    icon: Search,
    description:
      'Enter your URL. Our system crawls your pages, scores your design, conversion, and technical signals. You get a read-only report immediately — no email required.',
