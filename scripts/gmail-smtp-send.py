...
from email_ledger import DuplicateEmailAttemptError, begin_attempt, body_hash, get_db, update_attempt
...
def send_email(to, subject, body, html=False, lead_id="unknown", force_resend=False, reason=""):
    ...
    body_digest = body_hash(body)
    print(json.dumps({"event": "body_hash_computed", "attempt_id": attempt["id"], "draft_hash": body_digest}))
